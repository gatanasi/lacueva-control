...
<body>
	<div id='cssmenu'>
		<ul>
			...
			<li><a href='#inputs'><span>Ingresos</span></a></li>
			...
			<li class='has-sub'><a href="<c:url value="/admin" />" title="admin"><span>Administraci&oacute;n</span></a>
				<ul>
					<li class='has-sub'><a href="<c:url value="/admin/items" />" title="items"><span>Items</span></a>
						<ul>
							<li><a href="<c:url value="/admin/items/create" />" title="adminItemsCreate"><span>Create</span></a></li>
							<li class='last'><a href='#'><span>Sub Product</span></a></li>
						</ul></li>
					<li><a href='#shops'><span>Locales</span></a></li>
				</ul></li>
	...
	<script type="text/javascript">
		(function($) {
			$(document).ready(function() {
				...
				$("#cssmenu").bind("tabsselect", function(event, ui) {
